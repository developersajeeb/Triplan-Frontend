                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="grid gap-1">
                        ...
                        <Input
                            ...
                            required
                            className="w-full !text-base bg-white font-medium hover:border-primary-400 focus:border-primary-400 focus-visible:ring-0 px-3 py-5"
                        />
                    </div>
                    <div className="grid gap-1">
                        ...
                        <Input className="w-full !text-base bg-white font-medium hover:border-primary-400 focus:border-primary-400 focus-visible:ring-0 px-3 py-5" id="password" type="password" placeholder="Enter your password" required />
                    </div>
                    <Button type="submit" className="tp-primary-btn h-11 !rounded-lg">
                        Sign Up
                    </Button>
                    <div className="after:border-border relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-gray-300">
