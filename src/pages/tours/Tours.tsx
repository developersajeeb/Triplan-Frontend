                        ...
                        <div className='rounded-[10px] overflow-hidden bg-white shadow-[0px_4px_24px_0px_rgba(194, 194, 194, 0.25)]'>
                            ...
                            <div className='p-5'>
                                <div className='flex justify-between gap-2'>
                                    <p className='text-sm text-gray-800 font-semibold flex gap-1 w-full max-w-[150px]'><LuNotepadText className='text-primary-500 pt-1' size={16} /> Tour Type</p>
                                ...
                                <h2 className='mt-3 mb-1'><Link to="/tour-details" className='text-gray-800 hover:text-primary-500 text-xl font-bold cursor-pointer duration-300'>Rainbow Mountain Valley</Link></h2>
                                <p className='text-base text-gray-500 font-medium flex gap-1'><span><FaLocationDot size={20} className='pt-1' /></span> Shahrasti Chnagpur, Bangladesh</p>
                                <p className='text-base text-gray-500 font-medium flex gap-1 mt-1'><span><HiOutlineUsers size={20} className='pt-[2px]' /></span> 14 Guests</p>

                                <p className='text-gray-600 font-semibold mt-3'>Starts From <span className='text-primary-400 font-bold text-xl'>$500</span> <span className='text-gray-500 font-bold text-xl line-through'>$789</span></p>
                                ...
                                <div className='flex justify-between items-center gap-2'>
                                    ...
                                    <div className='text-end w-full max-w-[150px]'><Link to="/tour-details" className='text-[14px] inline-block font-semibold bg-primary-900 hover:bg-primary-400 text-white hover:text-white px-5 py-2 rounded-full transition duration-300;'>View Details</Link></div>
                                </div>
                            </div>
                        </div>
                    </div>
