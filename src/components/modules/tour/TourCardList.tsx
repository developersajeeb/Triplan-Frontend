...
const TourCardList = ({ tour }: Props) => {
    return (
        <div className='sm:flex group rounded-[10px] border border-gray-200 overflow-hidden bg-white shadow-[0px_4px_24px_0px_rgba(194, 194, 194, 0.25)]'>
            <div className='relative w-full h-[200px] sm:max-w-[300px] sm:h-full sm:min-w-[300px] sm:min-h-full overflow-hidden'>
                ...
                <img src={tour?.images[0] || ImageWaterMark} className='w-full h-[200px] sm:max-w-[300px] sm:h-full sm:min-w-[300px] sm:min-h-full overflow-hidden duration-300 group-hover:scale-110 rounded-t-[10px] sm:rounded-l-[10px] object-cover' alt="Tour Slider" />
            </div>
